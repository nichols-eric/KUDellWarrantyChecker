...
# Clear the console for easier debugging of multiple sequential runs in your IDE
Clear-Host
...
Set-Location $myPSScriptRoot
##TODO: Is this necessary anymore? I replaced all the relative paths with absolute paths

# Dot-source functions for writing to log files
. $MyPSScriptRoot\functions\Write-Log.ps1
